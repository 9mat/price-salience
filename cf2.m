function [ prob ] = cf2( theta, n, sigmaScale )
%CF2 Summary of this function goes here
...
Data.choice     = reshape(repmat(1:n.choice,nprices, 1), n.choice*nprices, 1);
Data.treat      = 2*ones(n.choice*nprices,1);
...
theta(offset + 1: offset + n.sigma) = s*sqrt(sigmaScale);

prob = choiceProb(theta, Data, n);
prob = reshape(prob, nprices, n.choice);
